//
//  CellQuestionMultipleChoicePicture.mm
...
@implementation CellQuestionMultipleChoicePicture

@synthesize lblQuestion;
//@synthesize imgPic, imgVwPic;
@synthesize imgVwPic;
...
const float fPic_PosX = 0.05;
const float fPic_PosY = 0.02;
const float fPic_Width = 0.9;
const float fPic_Height = 0.40;

const float fQuestion_PosX = 0.05;
const float fQuestion_PosY = 0.41;
const float fQuestion_Width = 0.9;
const float fQuestion_Height = 0.18;

const float fAnswerBtn1_PosX = 0.05;
const float fAnswerBtn1_PosY = 0.60;
const float fAnswerBtn1_Width = 0.9;
const float fAnswerBtn1_Height = 0.07;

const float fAnswerBtn2_PosX = 0.05;
const float fAnswerBtn2_PosY = 0.68;
const float fAnswerBtn2_Width = 0.9;
const float fAnswerBtn2_Height = 0.07;

const float fAnswerBtn3_PosX = 0.05;
const float fAnswerBtn3_PosY = 0.76;
const float fAnswerBtn3_Width = 0.9;
const float fAnswerBtn3_Height = 0.07;

const float fAnswerBtn4_PosX = 0.05;
const float fAnswerBtn4_PosY = 0.84;
const float fAnswerBtn4_Width = 0.9;
const float fAnswerBtn4_Height = 0.07;

const float fAnswerBtn5_PosX = 0.05;
const float fAnswerBtn5_PosY = 0.92;
const float fAnswerBtn5_Width = 0.9;
const float fAnswerBtn5_Height = 0.07;
...
//		}
		...
		[self.imgVwPic setImage:[[[UIApplication sharedApplication] delegate] GuiPicture:ePictureType]]; 
		...
		self.btnAnswer3 = [[UIButton alloc] initWithFrame:frmAnswerBtn3];
...
-(void) buttonPressed1 {
	...
	if ([sStatus isEqualToString:@"Finished"] != YES) {
		...
		if (self.bOnlyOneAnswer) {
			...
			[vCtrlParent btnMultipleChoiceSelected:self.iQuestionNo iChoice:0 bSelected:true];
			...
			[vCtrlParent btnMultipleChoiceSelected:self.iQuestionNo iChoice:0 bSelected:bBtnSelected1];
		};
