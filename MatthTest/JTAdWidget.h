...
/*!
 @method     category:
 @abstract   "Category" is the category of your application or the specific page/section displayed.
 @discussion  A list of valid categories can be found here:
              https://support.jumptap.com/index.php/Valid_Categories
 @param theWidget The particular widget being interrogated
 */
